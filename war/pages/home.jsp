			...
			<div class="aside">
				<h3>Information</h3>
 				<p>Welcome back <sec:authentication property="principal.nickname"/>.</p>
					! You can <br> <a href="/logout.jsp">Sign out</a>
				</p>
				<%
					if (total == 0) {
				%>
...
&nbsp;
<div class="footer">(c) Vincent Lee  <p>User Registered at: <sec:authentication property="principal.forename"/> <sec:authentication property="principal.surname"/><p></div>
</html>